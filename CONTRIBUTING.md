...
issue](https://github.com/cisagov/windows-vm2ami-prep/issues) in this
...
request](https://github.com/cisagov/windows-vm2ami-prep/pulls), you will
...
```console
cd windows-vm2ami-prep
pyenv virtualenv <python_version_to_use> windows-vm2ami-prep
pyenv local windows-vm2ami-prep
